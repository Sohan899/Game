class Obstacle {
    ...
    draw() {
       ...
       this.game.ctx.drawImage(this.image, this.frameX * this.spriteWidth,0,this.spriteWidth,this.spriteHeight,this.x,this.y,this.y,this.scaledWidth,this.scaleHeight);
        if(this.game.debug){
